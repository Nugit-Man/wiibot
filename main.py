...
async def changelog(ctx):
    await ctx.send_response(embed = discord.Embed(description="# WiiBot v0.3 - 03/23/2026\n- Ranked functionality has been added\n- Added three new admin-only commands: `/admin register`, `/admin startday`, and `/admin endday`\n- Bugfixed backend",colour=0xf4f4f4),view=ChangelogButton())
